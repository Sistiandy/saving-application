...
class User_model extends CI_Model {
    ...
    function get($params = array())
    {
        $this->db->select('user.user_id, user_name, user_password, user_full_name, user_description,
            user_email, user_input_date, user_last_update, user.role_id, user_role.role_name'); 
        ...
        {
            $this->db->where('user_name', $params['name']);
        }
    ...
    {
        $this->db->select('user_role.role_id, role_name, role_input_date, user_role.role_last_update'); 
        ...
        {
            $this->db->order_by('user_role.role_last_update', 'desc');
        }
